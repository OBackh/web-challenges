...
function findByLastName(employees, lastName) {
  return employees.find((element) => element.lastName === lastName);
}
...
function findByProfessionSubStringAndAge(employees, string, age) {
  return (
    employees.find((element) => element.profession.includes(string)) &&
    employees.find((element) => element.age >= age)
  );
}
